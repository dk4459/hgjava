...
<body>
  ...
  <div class ="center">
    ...
    <%if (pageDTO.isPrev()){ %>
     <a href ="boardList.do?page=<%=pageDTO.getStarPage()-1%>&searchCondition=<%=searchCondition%>&keyboard=<%=keyword%>"> &laquo </a>
    <%} %>
    ...
    <%} %>
    <%if (pageDTO.isNext()){ %>
     <a href ="boardList.do?page=<%=pageDTO.getEndPage()+1%>&searchCondition=<%=searchCondition%>&keyboard=<%=keyword%>"> &raquo </a>
    <%} %>
    </div>
    </div>
